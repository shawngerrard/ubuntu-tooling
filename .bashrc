...
eval `ssh-agent` && ssh-add ~/.ssh/github-shawngerrard && ssh-add ~/.ssh/ultron-rpi
...
# Create an env var for kubectl namespace
export ha=$(kubectl get namespaces | grep home | awk '{split($0,a," "); print a[1]}')
